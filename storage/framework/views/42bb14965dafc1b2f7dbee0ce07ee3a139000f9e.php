                ...
                <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                       ...
                       <?php if(!$selesai_dipinjam): ?>
                            <td>
                                <?php if($item->status == 1): ?>
                                    <span wire:click="pinjam(<?php echo e($item->id); ?>)" class="btn btn-sm btn-success mr-2">Konfirmasi Peminjaman</span>
                                <?php elseif($item->status == 2): ?>
                                    <span wire:click="kembali(<?php echo e($item->id); ?>)" class="btn btn-sm btn-primary mr-2">Konfirmasi Kembali</span>
                                <?php endif; ?>
                            </td>
                       <?php endif; ?>
                    </tr>
...
</div><?php /**PATH D:\xampp\htdocs\Projek-Akhir-PAW\resources\views/livewire/petugas/transaksi.blade.php ENDPATH**/ ?>