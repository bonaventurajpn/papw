<div class="container">
    ...
    <?php if($detail_buku): ?>
        ...
        <div class="col-md-4 mb-3">
            <h1 class="mt-0">Detail Jurnal</h1>
            <img src="<?php echo e(asset('storage/' . $buku->sampul)); ?>" alt="<?php echo e($buku->sampul); ?>" width="300" height="400">
        </div>
        <div class="col-md-8">
    ...
    <?php endif; ?>
</div><?php /**PATH D:\xampp\htdocs\Projek-Akhir-PAW\resources\views/livewire/peminjam/buku.blade.php ENDPATH**/ ?>